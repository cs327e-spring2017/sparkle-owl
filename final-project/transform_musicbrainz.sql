...
update artist set cname = btrim(split_part(cname,'.' , 1));
...
update artist_alias set cname = btrim(split_part(cname,'.' , 1));
...
update place set cname = btrim(split_part(cname,'.' , 1));
...
update label set cname = btrim(split_part(cname,'.' , 1));
